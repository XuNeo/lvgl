...
void test_textarea_properties(void)
{
    ...
    prop.num = 1;
    TEST_ASSERT_TRUE(lv_obj_set_property(obj, &prop) == LV_RES_OK);
    TEST_ASSERT_EQUAL_INT(1, lv_textarea_get_one_line(obj));
    TEST_ASSERT_EQUAL_INT(1, lv_obj_get_property(obj, LV_PROPERTY_TEXTAREA_ONE_LINE).num);
    ...
    prop.num = 1;
    TEST_ASSERT_TRUE(lv_obj_set_property(obj, &prop) == LV_RES_OK);
    TEST_ASSERT_EQUAL_INT(1, lv_textarea_get_text_selection(obj));
    TEST_ASSERT_EQUAL_INT(1, lv_obj_get_property(obj, LV_PROPERTY_TEXTAREA_TEXT_SELECTION).num);
